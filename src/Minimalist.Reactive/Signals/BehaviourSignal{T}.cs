...
public class BehaviourSignal<T> : ISignal<T>
{
    ...
    /// </value>
    public bool HasObservers => _outObserver is not EmptyObserver<T> && !_isStopped && !IsDisposed;
    ...
    private class Subscription : IDisposable
    {
        ...
        private BehaviourSignal<T>? _parent;
        private IObserver<T>? _unsubscribeTarget;

        public Subscription(BehaviourSignal<T> parent, IObserver<T> unsubscribeTarget)
        {
            _parent = parent;
