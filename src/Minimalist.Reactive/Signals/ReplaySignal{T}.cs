...
public class ReplaySignal<T> : ISignal<T>
{
    ...
    /// </value>
    public bool HasObservers => (_outObserver as ListObserver<T>)?.HasObservers ?? false;
    ...
    private class Subscription : IDisposable
    {
        ...
        private ReplaySignal<T>? _parent;
        private IObserver<T>? _unsubscribeTarget;

        public Subscription(ReplaySignal<T> parent, IObserver<T> unsubscribeTarget)
        {
            _parent = parent;
